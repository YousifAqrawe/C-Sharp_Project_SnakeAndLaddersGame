...
namespace Object_Classes
{
    ...
    public class Player
    {
        public static int combind_dice = 0;
        ...
        ///////////// if (int fuelLeft == true) {fuelLeft > 0};
        ...
        public void Play(Die d1, Die d2)
        {
            ...
            // int dice_1 = d1.Roll(); // dice_1 that used to move the player position
            //int dice_2 = d2.Roll(); // dice_2 that used to move the player position
            int combind_dice = d1.Roll() + d2.Roll(); // 

            Position = Position + combind_dice; // update
        ...
        private bool ReachedFinalSquare()
        {
            ...
            //  CODE NEEDS TO BE ADDED HERE
            if (position >= Board.NUMBER_OF_SQUARES) // I have to mention the Board by returning it because it
                                                     // refers to the START_SQUARE_NUMBER in the Board class
